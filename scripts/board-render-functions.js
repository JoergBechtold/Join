...
/**
 * Adds an event listener to the window's resize event.
 * On resize, it triggers `updateMobileDropdowns()` to ensure
 * dropdown elements are updated for responsive layouts.
 */
